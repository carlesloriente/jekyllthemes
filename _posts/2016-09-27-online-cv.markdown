...
* Printable version of the site can be found at `https://<username>.github.io/online-cv/print`. Use a third party link [pdflayer](https://pdflayer.com/), [web2pdf](https://www.web2pdfconvert.com/) etc to get the printable PDF.
