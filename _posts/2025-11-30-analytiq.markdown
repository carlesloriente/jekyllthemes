...
`{% include excalidraw-embed.html file="/assets/excalidraw/architecture.excalidraw" height="800px" %}`
...
`{% include alert.html type="info" message="This is an informational alert." %}`

Types: `info`, `warning`, `error`, `success`

#### Button

`{% include button.html text="Click Me" url="/page" style="primary"%}`

Styles: `primary`, `secondary`, `outline`

#### Card

`{% include card.html title="Card Title" content="Card content goes here." image="/assets/images/card-image.jpg" %}`
