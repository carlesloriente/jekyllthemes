...
![dotx - free Jekyll theme](https://raw.githubusercontent.com/nandomoreirame/dotX/master/screenshot.png)

---

## Copyright and license

It is under [the MIT license](https://github.com/nandomoreirame/dotX/blob/master/LICENSE).
