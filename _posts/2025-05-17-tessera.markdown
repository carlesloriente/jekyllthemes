...
You can see common modifications on [Wiki](https://github.com/ItsZariep/Tessera/wiki/Common-modifications-and-additions:){:target="_blank"}{:rel="noopener noreferrer"}

You can also see guides on [Tessera site](https://itszariep.github.io/Tessera){:target="_blank"}{:rel="noopener noreferrer"}

## Bugs and Issues

Report issues on [Tessera GitHub](https://github.com/ItsZariep/Tessera/issues){:target="_blank"}{:rel="noopener noreferrer"}

## Contribute

Contribute o [Tessera GitHub](https://github.com/ItsZariep/Tessera/pulls){:target="_blank"}{:rel="noopener noreferrer"}
